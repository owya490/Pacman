...
class AmbusherTest {
    ...
    public void tickTest() {
        ...
        MazeBuilder mb = new MazeBuilder("mapAmbusherTest2.txt", null, null, null, null, null, null, null, null, null);
        ArrayList<soda> s = mb.sodaList();
        ArrayList<Fruit> f = mb.fruitList();
        ArrayList<superFruit> sf = mb.superFruitList();
        ArrayList<GhostObject> g = new ArrayList<GhostObject>();
        ...
        String[][] map = fileReader.convertToArray(fileReader.readLines("mapAmbusherTest2.txt"));
        MazePath mp = new MazePath();
        boolean[][] path = mp.createPath(map);
        Player p = new Player(s, sf, f, map, path, 1, 1, "mapAmbusherTest2.txt", null, null, null, null, null);

        ml.add(1);
    
        Ambusher a = new Ambusher(null, findGhostStart.ambusherfindx("mapAmbusherTest2.txt").get(0), findGhostStart.ambusherfindy("mapAmbusherTest2.txt").get(0), null, null, ml, 1, path, p, g, 1, 1);
