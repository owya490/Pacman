...
class AmbusherTest {
    ...
    public void tickTest() {
        ...
        p = new Player(s, sf, f, map, path, 1, 1, "mapAmbusherTest2.txt", null, null, null, null, null);

        ml.add(1);
    
        a = new Ambusher(null, findGhostStart.ambusherfindx("mapAmbusherTest2.txt").get(0), findGhostStart.ambusherfindy("mapAmbusherTest2.txt").get(0), null, null, ml, 1, path, p, g, 1, 1);
        for (int i = 0; i < 150; i ++) {
            p.tick('a');
            a.tick('a');
        }
