...
class AmbusherTest {
    ...
    public void tickTest() {
        ...
        Ambusher a = new Ambusher(null, findGhostStart.ambusherfindx("mapAmbusherTest2.txt").get(0), findGhostStart.ambusherfindy("mapAmbusherTest.txt").get(0), null, null, ml, 1, path, p, g, 1, 1);
