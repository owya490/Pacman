...
class ChaserTest {
    ...
    public void tickTest() {
        ...
        Chaser a = new Chaser(null, findGhostStart.ambusherfindx("mapChaserTest.txt").get(0), findGhostStart.ambusherfindy("mapChaserTest.txt").get(0), null, null, ml, 1, path, p, g, 1, 1);
