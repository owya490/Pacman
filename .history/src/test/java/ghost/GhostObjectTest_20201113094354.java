...
class GhostObjectTest {
    ...
    public void debugTests() {
        ...
        char [] test = a.upOrDownRandom();
        char [] t1 = new char[] {'w', 'a', 's', 'd'};
        char [] t2 = new char[] {'a', 's', 'd', 'w'};
        char [] t3 = new char[] {'s', 'd', 'w', 'a'};
        char [] t4 = new char[] {'d', 'w', 'a', 's'};
        if (Arrays.equals(test, t1) | Arrays.equals(test, t2) | Arrays.equals(test, t3) | Arrays.equals(test, t4)) {
            assertEquals(a.setPlayerX_g(1), 1);
        } else {
            assertEquals(a.setPlayerX_g(1), 2);
        }
    }
