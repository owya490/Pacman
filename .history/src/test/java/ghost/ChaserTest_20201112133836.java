...
class ChaserTest {
    ...
    public void tickTest() {
        ...
        Chaser a = new Chaser(null, findGhostStart.ambusherfindx("mapAmbusherTest.txt").get(0), findGhostStart.ambusherfindy("mapAmbusherTest.txt").get(0), null, null, ml, 1, path, p, g, 1, 1);
