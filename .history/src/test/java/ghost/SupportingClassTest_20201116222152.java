...
class SupportingClassTest {
    ...
    public void findGhostStartTest() {
        ...
        assertEquals(findGhostStart.ambusherfindy("map.txt").get(0), 16);

        assertEquals(findGhostStart.chaserfindx("map.txt").get(0), 16);

        assertEquals(findGhostStart.chaserfindy("map.txt").get(0), 16);

        assertEquals(findGhostStart.ignorantfindx("map.txt").get(0), 16);

        assertEquals(findGhostStart.ignorantfindx("map.txt").get(0), 16);

        assertEquals(findGhostStart.whimfindx("map.txt").get(0), 16);
