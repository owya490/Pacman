...
class AmbusherTest {
    ...
    public void tickTest() {
        ...
        Ambusher a = new Ambusher(null, findGhostStart.ambusherfindx("mapAmbusherTest.txt").get(0), findGhostStart.ambusherfindy("map2.txt").get(0), null, null, ml, 1, path, p, g, 1, 1);
