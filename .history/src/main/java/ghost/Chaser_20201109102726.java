...
public class Chaser extends GhostObject {
    ...
    public Chaser(int x, int y, PImage ghost, PImage ghost_scared, ArrayList<Integer> modeLengths1, int speed, boolean[][] path, Player player_g, ArrayList<GhostObject> other_ghosts, int frightenedLength){
    ...
    public void tick(char input) {
        ...
        if (this.isFrightened == true) {
            if (this.frightenedFrames == frightenedLength*60) {
                ...
                //System.out.println(this.frightenedFrames);
            }
    ...
    public void draw (PApplet app) {
        ...
        if (this.isDead == false) {
            if (this.debug & this.isFrightened == false) {
                if (this.scatter == false & this.isFrightened == false) {
                    app.stroke(255, 255, 255);
                    upOrDown();
    
                    app.line(this.x+13, this.y+13, this.player_x+13, this.player_y+13);
                }
                else if (this. scatter == true  & this.isFrightened == false) {
                    app.stroke(255, 255, 255);
                    upOrDownCorner();
