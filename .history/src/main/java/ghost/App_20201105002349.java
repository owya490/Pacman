    ...
    public void setup() {
        ...
        for (String c : this.ghost_x){
            if (c.equals("a") {
                ...
                this.ghost_obj.add(new Chaser(this.ghost_x.get(x), this.ghost_y.get(index), this.chaser, this.ghost_scared, this.modeLengths_i_f, this.speed, this.mazepath, this.player));
                index ++;
            }
            else if (c.equals("i") {
                this.ghost_obj.add(new Ignorant(this.ghost_x.get(x), this.ghost_y.get(index), this.chaser, this.ghost_scared, this.modeLengths_i_f, this.speed, this.mazepath, this.player));
                ...
                this.ghost_obj.add(new Whim(this.ghost_x.get(x), this.ghost_y.get(index), this.chaser, this.ghost_scared, this.modeLengths_i_f, this.speed, this.mazepath, this.player));
                index ++;
            }
        }
