...
public class Ambusher extends GhostObject {
    ...
    public Ambusher(PImage sodaGhost, int x, int y, PImage ghost, PImage ghost_scared, ArrayList<Integer> modeLengths1, int speed, boolean[][] path, Player player_g, ArrayList<GhostObject> other_ghosts, int frightenedLength){
    ...
    public void tick(char input) {
        if (this.sodaEffect == true) {
            if (this.sodaFrames == 3*60) { //implement soda length
