...
public class App extends PApplet {
    ...
    public void setup() {
        ...
        for (String c : this.ghost_x.keySet()){
            if (c.equals("a")) {
                this.ghost_obj.add(new Ambusher(this.ghost_x.Value("a"), this.ghost_y.getValue("a"), this.chaser, this.ghost_scared, this.modeLengths_i_f, this.speed, this.mazepath, this.player));
                index ++;
            }
            else if (c.equals("c")) {
