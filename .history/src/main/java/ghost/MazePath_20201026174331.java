...
public class MazePath {
    ...
    public static boolean[][] createPath(String[][] maze) {
        ...
        //     for (int x = 1; x < maze[0].length; x ++)   || maze[i][j].equals("0")
        for (int i = 1; i < 36; i ++) {
            for (int j = 1; j < 28; j ++) {
                if (before == true) {
                    if (maze[i][j].equals("7") || maze[i][j].equals("g") || maze[i][j].equals("p")){
                        before = true;
                    }
                    else {
                        end = j - 1;
                ...
                else if (maze[i][j].equals("7") || maze[i][j].equals("g") || maze[i][j].equals("p")){
