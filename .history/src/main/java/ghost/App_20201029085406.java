...
public class App extends PApplet {
    ...
    public void setup() {
        ...
        for (int x = 0; x < this.ghost_x.size(); x ++) {
            this.ghost_obj.add(new Ghost(this.ghost_x.get(x), this.ghost_y.get(index), this.ghost, this.modeLengths, this.speed, this.mazepath, this.player.x, this.player.y));
            index ++;
        }
