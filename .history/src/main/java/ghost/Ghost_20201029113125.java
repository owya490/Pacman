...
public class Ghost {
    ...
    public ArrayList<Integer> modeLengths_f = new ArrayList<Integer>();
    public String[] arr;
    ...
    public Ghost(int x, int y, PImage ghost, ArrayList<Integer> modeLengths1, int speed, boolean[][] path, Player player_g){
        this.ghost = ghost;
    ...
    public void tick() {
        ...
        if (this.frames % (modeLengths1.get(this.index_scatter) * 60) == 0) {
            setScatter();
            this.index_scatter ++;
            System.out.println(this.scatter);
        }
        if (this.index_scatter == modeLengths1.size() -1) {
