...
public class App extends PApplet {
    ...
    public void setup() {
        ...
        for(Integer g : this.ignorant_ghost_x) {
            this.ghost_obj.add(new Ignorant(this.ignorant_ghost_x.get(index), this.ignorant_ghost_y.get(index), this.ignorant, this.ghost_scared, this.modeLengths_i_f, this.speed, this.mazepath, this.player, this.ghost_obj));
            index ++;
        }
        index = 0;

        for(Integer g : this.chaser_ghost_x) {
            this.ghost_obj.add(new Chaser(this.chaser_ghost_x.get(index), this.chaser_ghost_y.get(index), this.chaser, this.ghost_scared, this.modeLengths_i_f, this.speed, this.mazepath, this.player, this.ghost_obj));
            index ++;
        }
        index = 0;

        for(Integer g : this.whim_ghost_x) {
            this.ghost_obj.add(new Whim(this.whim_ghost_x.get(index), this.whim_ghost_y.get(index), this.whim, this.ghost_scared, this.modeLengths_i_f, this.speed, this.mazepath, this.player, this.ghost_obj));
            index ++;
        }
