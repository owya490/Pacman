...
public class App extends PApplet {
    ...
    public HashMap<String, Integer> ghost_x;
    public HashMap<String, Integer> ghost_y;
    ...
    public void setup() {
        ...
        for (String c : this.ghost_x){
            if (c.equals("a")) {
                this.ghost_obj.add(new Ambusher(this.ghost_x.getValue("a"), this.ghost_y.getValue("a"), this.chaser, this.ghost_scared, this.modeLengths_i_f, this.speed, this.mazepath, this.player));
                index ++;
            }
            else if (c.equals("c")) {
                this.ghost_obj.add(new Chaser(this.ghost_x.getValue("c"), this.ghost_y.getValue("c"), this.chaser, this.ghost_scared, this.modeLengths_i_f, this.speed, this.mazepath, this.player));
                index ++;
            }
            else if (c.equals("i")) {
                this.ghost_obj.add(new Ignorant(this.ghost_x.getValue("i"), this.ghost_y.getValue("i"), this.chaser, this.ghost_scared, this.modeLengths_i_f, this.speed, this.mazepath, this.player));
                index ++;
            }
            else if (c.equals("w")) {
                this.ghost_obj.add(new Whim(this.ghost_x.getValue("w"), this.ghost_y.getValue("w"), this.chaser, this.ghost_scared, this.modeLengths_i_f, this.speed, this.mazepath, this.player));
                index ++;
            }
        }
