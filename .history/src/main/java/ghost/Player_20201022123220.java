...
public class Player {
    ...
    public void draw(PApplet app) {
        ...
        if (this.openMouth && this.input =='a') {
            app.image(this.playerLeft, x, y-4);
        } 
        if (this.openMouth && this.input =='s') {
            app.image(this.playerDown, x, y-4);
        } 
        if (this.openMouth && this.input =='d') {
            app.image(this.playerRight, x, y-4);
        } 
