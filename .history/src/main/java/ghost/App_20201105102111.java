...
public class App extends PApplet {
    ...
    public void setup() {
        ...
        for (String c : this.ghost_x.keySet()){
            ...
            // else if (c.equals("w")) {
            //     this.ghost_obj.add(new Whim(this.ghost_x.get("i"), this.ghost_y.get("i"), this.whim, this.ghost_scared, this.modeLengths_i_f, this.speed, this.mazepath, this.player, this.ghost_obj));
            //     index ++;
            // }
            // else if (c.equals("w")) {
