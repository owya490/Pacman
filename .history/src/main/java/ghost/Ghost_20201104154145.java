...
public class Ghost extends MovingEntities{
    ...
    public void tick(char input) {
        ...
        else if (this.player_x + speed == this.x + 20 & this.player_y == this.y) {
            player_g.setDead(true);
            this.x = this.beg_x;
            this.y = this.beg_y;
            //this.index_scatter =0;
        ...
        else if (this.player_x == this.x & this.player_y + speed == this.y + 8) {
            player_g.setDead(true);
            this.x = this.beg_x;
            this.y = this.beg_y;
            //this.index_scatter =0;
        ...
        else if (this.player_x == this.x & this.player_y- speed== this.y - 20) {
            player_g.setDead(true);
            this.x = this.beg_x;
            this.y = this.beg_y;
            //this.index_scatter =0;
