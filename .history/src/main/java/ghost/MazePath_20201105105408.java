...
public class MazePath {
    ...
    public static boolean[][] createPath(String[][] maze) {
        ...
        for (int y = 1; y < 36; y ++) {
            for (int x = 1; x < 28; x ++) {
                if (cellBefore == true) {
                    if (maze[y][x].equals("7") || maze[y][x].equals("c") || maze[y][x].equals("p") || maze[y][x].equals("a") || maze[y][x].equals("i") || maze[y][x].equals("w") || maze[y][x].equals("8")){
                        cellBefore = true;
                    }
                    else {
                        end = x - 1;
                ...
                else if (maze[y][x].equals("7") || maze[y][x].equals("c") || maze[y][x].equals("p") || maze[y][x].equals("a") || maze[y][x].equals("i") || maze[y][x].equals("w") || maze[y][x].equals("8")){
                    start = x;
                    cellBefore = true;
                }
            }
