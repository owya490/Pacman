...
public class App extends PApplet {
    ...
    public void setup() {
        ...
        try{
            ...
            ArrayList<Long> modeLengths_i = new ArrayList<Long>();

            for (int i = 0; i < modeLengths1.size(); i ++) {
                System.out.println(modeLengths1.get(i));
                modeLengths_i.add((long)modeLengths1.get(i));
            }
        ...
        for (int x = 0; x < this.ghost_x.size(); x ++) {
            this.ghost_obj.add(new Ghost(this.ghost_x.get(x), this.ghost_y.get(index), this.ghost, this.modeLengths1, this.speed, this.mazepath, this.player));
            index ++;
