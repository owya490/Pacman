    ...
    public void setup() {
        ...
        for (String c : this.ghost_x.keySet()){
            if (c.equals("a")) {
                ...
                this.ghost_obj.add(new Whim(this.ghost_x.get("i"), this.ghost_y.get("i"), this.ignorant, this.ghost_scared, this.modeLengths_i_f, this.speed, this.mazepath, this.player, this.ghost_obj));
                index ++;
            }
            // else if (c.equals("w")) {
