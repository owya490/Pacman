...
public class Whim extends GhostObject {
    ...
    public Whim(int x, int y, PImage ghost, PImage ghost_scared, ArrayList<Integer> modeLengths1, int speed, boolean[][] path, Player player_g, ArrayList<GhostObject> other_ghosts, int frightenedLength){
    ...
    public void draw (PApplet app) {
        ...
        if (this.scatter == true | this.tempScatter == true) {
