...
public class Player {
    ...
    public Player(boolean[][] path, long lives, long speed, String filename, PImage playerClosed, PImage playerDown, PImage playerLeft, PImage playerRight, PImage playerUp) {
    ...
    public void tick(char input) {
        ...
        if (path[(int) this.y += this.yvel][(int) this.x += this.xvel]== true) {
            this.x += this.xvel;
            this.y += this.yvel;
        } else {
            this.xvel = 0;
