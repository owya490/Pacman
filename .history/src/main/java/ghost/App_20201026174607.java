...
import java.awt.evet.getKeyCode;
...
public class App extends PApplet {
    ...
    public void setup() {
        ...
        this.player = new Player(this.lines_f, this.mazepath, this.lives, this.speed, this.map, this.playerClosed, this.playerDown, this.playerLeft, this.playerRight, this.playerUp);
