...
public class MazePath {
    ...
    /**
     * The constructor for the MazePath Class
     */
    public MazePath(){};

    /**
     * The method that creates a 2D boolean array for the traversable path
     * @param maze the maze on which the traversable path is created
     * @return the traversable path in the form of a 2D boolean array
     */
